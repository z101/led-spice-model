...
def fit_diode_model(current, voltage, initial_points = 1e6, Vt = 26e-3, n_guess = 1.5):
...
def main():
    ...
    if not datFiles:
        print(f'No data files found by pattern "{DAT_FILES_PATTERN}"')
        exit(1)
    ...
    for datFile in datFiles:
        ...
        print()
        print(f'.MODEL LED D(Is={Is}, n={n}, Rs={Rs})')
        print()
